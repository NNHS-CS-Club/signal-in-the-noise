...
public class Notes
{
    public static void createArrayOfEvens()
    {
         ...
         *      on its index. Indicies are zero based.
         */
    ...
    public static void createArrayOfOdds()
    {
        ...
        // this won't compile because we've already intialized an array literal
        //odds = { 1, 3, 5 };
        ...
        for(int odd: odds)
        {
            odd += 1;  // if we changed the array this should increment each value to be even
        }
        for(int odd : odds)
        {
